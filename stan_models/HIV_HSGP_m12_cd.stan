...
transformed parameters
{
  ...
  //age-specific effect to account for the under-reporting for females
  {
   ...
   matrix[A1, A2] raw_log_effect_ur_f; // GP approx for log_effect_age_under_report_f
    ...
    // local scope
    raw_f =  hsgp_matern12(A1, gpscale, lscale_1, lscale_2, L_age1, L_age2, M_age1, M_age2, PHI1, PHI2, z);
    raw_log_effect_ur_f =  hsgp_matern12(A2, gpscale_ur, lscale_ur_1, lscale_ur_2, L_age1, L_age2, M_age1, M_age2, PHI1, PHI2, z_ur);
