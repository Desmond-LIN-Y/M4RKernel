...
transformed parameters
{
  ...
  { // local scope
    ...
    f_MM = to_matrix(hsgp_m52_2d(z[,1], gp_alpha[MM], gp_rho_1[MM], gp_rho_2[MM], L1, L2, S2, PHI)[sym_from_lowertri_idxset], A, A);
    f_MF = to_matrix(hsgp_m52_2d(z[,2], gp_alpha[MF], gp_rho_1[MF], gp_rho_2[MF], L1, L2, S2, PHI2), A, A);
    f_FF = to_matrix(hsgp_m52_2d(z[,3], gp_alpha[FF], gp_rho_1[FF], gp_rho_2[FF], L1, L2, S2, PHI)[sym_from_lowertri_idxset], A, A);
