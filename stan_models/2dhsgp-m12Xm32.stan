...
transformed parameters
{
  ...
  { // local scope
    ...
    vector[A2] fmm = hsgp_m32_2d(z[,1], gp_alpha[MM], gp_rho_1[MM], gp_rho_2[MM], L1, L2, S2, PHI) .* hsgp_m12_2d(z[,1], 1,  gp_rho_1[MM], gp_rho_2[MM], L1, L2, S2, PHI); 
    vector[A*A] fmf = hsgp_m32_2d(z[,2], gp_alpha[MF], gp_rho_1[MF], gp_rho_2[MF], L1, L2, S2, PHI2) .* hsgp_m12_2d(z[,2], 1, gp_rho_1[MF], gp_rho_2[MF], L1, L2, S2, PHI2);
    vector[A2] fff = hsgp_m32_2d(z[,3], gp_alpha[FF], gp_rho_1[FF], gp_rho_2[FF], L1, L2, S2, PHI) .* hsgp_m12_2d(z[,3], 1, gp_rho_1[FF], gp_rho_2[FF], L1, L2, S2, PHI);
