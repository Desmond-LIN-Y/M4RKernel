...
cat( "Configuring IO ...\n")
option_list <- list(
  make_option(c("-i", "--in"), type = "character", default = "D:/Math/Y4/M4R/bayes-rate-consistency", help = "repository path", dest = "repo_path"),
  make_option(c("-o", "--out"), type = "character", default = "D:/Math/Y4/M4R/results", help = "output path", dest = "out_path"),
...
config <- yaml::read_yaml("D:/Math/Y4/M4R/bayes-rate-consistency/config/covid-single.yml")

# Load data
contact_data <- readRDS("D:/Math/Y4/M4R/bayes-rate-consistency/data/COVIMOD/COVIMOD_wave_1.rds")
