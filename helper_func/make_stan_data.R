init_values <- function(){
  init_1 = list(
    nu=1, 
    gp_rho_1= c(0.9, 0.8, 0.9),
    gp_rho_2= c(1.1, 1.2, 1.3),
    gp_alpha= c(0.1,0.2,0.3),
    beta_0 = rnorm(4, 0, 1))

  init_2 = list(
    nu=1, 
    gp_rho_1= c(1,1,1),
    gp_rho_2=c(2.2,3.3,1.1),
    gp_alpha=c(0.1,0.3,0.2),
    beta_0 = rnorm(4,0,1))
  ...
  return(list(init_1, init_2, init_3, init_4))
}
